...
NEWS_QUERIES = [
    ...
    "news headlines", "any breaking news", "current news","read news"
]

HEALTH_QUERIES = [
    "i have a health issue", "i am having a health problem", "i am feeling sick", "i am unwell", "i feel ill","not feeling well","i am not well",
